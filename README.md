...
## Project goals:
  ...
  - The form should add to your state non-destructively. NO POST. THIS WILL BE PURELY IN THE FRONT-END.
  - BONUS: Try to see if you can filter the pokemon in a separate component instead of directly inside the PokemonIndex Component.
